...
public class ScruffyStats : MonoBehaviour
{
    ...
    public void FlatHeal(int flatheal)
    {
        ...
        DamagePopUp indicator = Instantiate(HealthText, transform.position, Quaternion.identity)
            .GetComponent<DamagePopUp>();
    ...
    public IEnumerator TakeDamageOverTimeX(
        string DOTType,
        int damages,
        float duration,
        float tickSpeed
    ...
    public void TakeDamage(int damagetaken)
    {
        ...
        else
        {
            ...
            {
                DamagePopUp indicator = Instantiate(
                        DamageText,
                        transform.position,
                        Quaternion.identity
                    )
    ...
    private IEnumerator DeathSequence()
    {
        ...
        GameObject deathScreen = Instantiate(
            deathScreenPrefab,
            transform.position,
            Quaternion.identity
        );
